...
function makeDeps(): ToolExecutionDeps {
  return {
    ...
    createRefund: vi.fn().mockResolvedValue({ ...toolOk("createRefund"), refundedShopCents: 1234 }),
    createPartialRefund: vi.fn().mockResolvedValue({ ...toolOk("createPartialRefund"), refundedShopCents: 500 }),
    ...
    issueStoreCredit: vi.fn().mockResolvedValue({ ...toolOk("issueStoreCredit"), spentShopCents: 2500 }),
    createGiftCard: vi.fn().mockResolvedValue({ ...toolOk("createGiftCard"), spentShopCents: 2500 }),
