...
"[project]/apps/dashboard/src/app/api/orders/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withOrgRoute"])({
    ...
    let headers;
    try {
        ({ data, headers } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$shopify$2f$client$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shopifyRest"])(ctx, 'orders.json', {
            query,
            maxRetries: 0
        }));
    } catch (err) {
    ...
    const orders = data.orders ?? [];
    const nextPageInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$shopify$2f$client$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNextPageInfo"])(headers);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0t0ngk4._.js.map