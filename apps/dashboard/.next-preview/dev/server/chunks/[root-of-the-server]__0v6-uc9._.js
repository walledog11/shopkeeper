...
"[project]/apps/dashboard/src/app/api/org/_lib/settings.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ORG_PATCH_KEYS = new Set([
    'name',
    'settings',
    'settingsUnset',
    'version'
]);
function hasVersionConflict(version, org) {
    return version !== undefined && version !== org.updatedAt.toISOString();
}
function parseOrgPatchBody(value) {
    if (!isPlainObject(value)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Invalid request body');
    }
    ...
    if (value.name !== undefined && typeof value.name !== 'string') {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Invalid name');
    }
    if (value.version !== undefined && typeof value.version !== 'string') {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Invalid version');
    }
    let settings;
    if (value.settings !== undefined) {
        try {
            settings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseOrgSettingsPatch"])(value.settings);
        } catch (error) {
            if (!(error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OrgSettingsValidationError"])) throw error;
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Invalid settings', error.issues.map((issue)=>({
...
function versionConflictResponse(org) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'stale_version',
        ...
        current: {
            id: org.id,
            name: org.name,
            settings: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeStoredOrgSettings"])(org.settings),
...
function buildSettingsUpdate(currentSettings, newSettings, settingsUnset) {
    const settingsChanged = newSettings !== undefined || settingsUnset.length > 0;
    const updatedSettings = mergeSettingsPatch(toPlainRecord((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeStoredOrgSettings"])(currentSettings)), toPlainRecord(newSettings));
...
function parseSettingsUnset(settingsUnset) {
    ...
    if (!Array.isArray(unsetPaths) || unsetPaths.some((path)=>typeof path !== 'string' || !ALLOWED_SETTINGS_UNSET.has(path))) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Invalid settingsUnset');
    }
    return unsetPaths;
}
function validateBusinessHoursWindow(settings) {
    if (settings.businessHoursEnabled !== true) return;
    const start = typeof settings.businessHoursStart === 'number' ? settings.businessHoursStart : __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AGENT_SETTINGS_DEFAULTS"].businessHoursStart;
    const end = typeof settings.businessHoursEnd === 'number' ? settings.businessHoursEnd : __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AGENT_SETTINGS_DEFAULTS"].businessHoursEnd;
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isValidBusinessHoursWindow"])(start, end)) return;
    throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Invalid settings', [
        {
            code: 'invalid_setting',
...
function mergeSettingsPatch(currentSettings, newSettings) {
    const merged = {
        ...currentSettings
    };
...
function deleteSettingPath(settings, path) {
...
"[project]/apps/dashboard/src/lib/billing/stripe.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_context__.P("apps/dashboard/src/lib/billing/stripe.ts")}`;
    },
    get turbopackHot () {
        return __turbopack_context__.m.hot;
    }
...
;
const require = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$module__$5b$external$5d$__$28$node$3a$module$2c$__cjs$29$__["createRequire"])(__TURBOPACK__import$2e$meta__.url);
const StripeClient = __turbopack_context__.r("[externals]/stripe [external] (stripe, cjs, [project]/node_modules/stripe)");
...
"[project]/apps/dashboard/src/app/api/org/_lib/delete-workspace.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$billing$2f$stripe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/dashboard/src/lib/billing/stripe.ts [app-route] (ecmascript)");
...
;
;
const LAST_WORKSPACE_MESSAGE = 'This is your only workspace. Create another workspace first, or delete your account from Settings → Account to leave Shopkeeper.';
async function readWorkspaceDeleteConfirmation(request) {
    const body = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$body$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readOptionalJsonObject"])(request, {
        malformed: {
...
function hasOtherWorkspace(memberships, clerkOrgId) {
    return memberships.data.some((m)=>m.organization.id !== clerkOrgId);
}
async function cancelWorkspaceSubscription(org) {
    if (!org.stripeSubscriptionId) return;
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$billing$2f$stripe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].subscriptions.cancel(org.stripeSubscriptionId);
    } catch (err) {
        const code = err?.code;
        if (code !== 'resource_missing') {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error({
                err,
                orgId: org.id
            }, '[Org DELETE] Failed to cancel Stripe subscription');
            throw err;
        }
    }
}
}),
"[project]/apps/dashboard/src/app/api/org/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$org$2f$_lib$2f$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/dashboard/src/app/api/org/_lib/settings.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$org$2f$_lib$2f$delete$2d$workspace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/dashboard/src/app/api/org/_lib/delete-workspace.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET() {
    try {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["handleApiError"])(error, 'Org GET', 'Failed to fetch org');
    }
}
async function PATCH(request) {
    try {
        const org = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$server$2f$org$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrCreateOrg"])();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$billing$2f$write$2d$gate$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertBillingWriteAllowed"])(org);
        const body = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$body$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readRequiredJsonObject"])(request, {
            malformed: {
                message: 'Invalid JSON body'
            },
            empty: {
        ...
        const { name, settings: newSettings, settingsUnset, version } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$org$2f$_lib$2f$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseOrgPatchBody"])(body);
        ...
        const settingsUpdate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$org$2f$_lib$2f$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildSettingsUpdate"])(org.settings, newSettings, settingsUnset);
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$org$2f$_lib$2f$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasVersionConflict"])(version, org)) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$org$2f$_lib$2f$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["versionConflictResponse"])(org);
        }
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].organization.update({
            where: {
                id: org.id
            },
            data: {
        ...
        if (name !== undefined) {
            const { orgId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$app$2d$router$2f$server$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"])();
            if (orgId) {
                const client = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$clerkClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clerkClient"])();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            id: updated.id,
            name: updated.name,
            settings: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeStoredOrgSettings"])(updated.settings),
            version: updated.updatedAt.toISOString()
        });
    } catch (error) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["handleApiError"])(error, 'Org PATCH', 'Failed to update org');
    }
}
async function DELETE(request) {
    try {
        const { orgId, userId, orgRole } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$app$2d$router$2f$server$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"])();
        if (!orgId || !userId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Unauthorized'
            }, {
        ...
        const org = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$server$2f$org$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrCreateOrg"])();
        const confirmName = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$org$2f$_lib$2f$delete$2d$workspace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readWorkspaceDeleteConfirmation"])(request);
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$org$2f$_lib$2f$delete$2d$workspace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasOtherWorkspace"])(memberships, org.clerkOrgId)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'last_workspace',
                message: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$org$2f$_lib$2f$delete$2d$workspace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LAST_WORKSPACE_MESSAGE"]
            }, {
                status: 409
            });
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$org$2f$_lib$2f$delete$2d$workspace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cancelWorkspaceSubscription"])(org);
        await client.organizations.deleteOrganization(org.clerkOrgId);
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].organization.deleteMany({
            where: {
                id: org.id
            }
        });
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["handleApiError"])(error, 'Org DELETE', 'Failed to delete workspace');
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__0v6-uc9._.js.map