...
"[project]/apps/dashboard/src/app/api/kb/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withOrgRoute"])({
    ...
    const knowledgeBases = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].knowledgeBase.findMany({
        where: {
    ...
    const [allTime, lastWeek] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].kbCitation.groupBy({
            by: [
                'kbArticleId'
            ],
            where: {
    ...
    const totalByArticle = new Map(allTime.map((r)=>[
            r.kbArticleId,
            {
                count: r._count._all,
                lastCitedAt: r._max.createdAt
            }
        ]));
    const weekByArticle = new Map(lastWeek.map((r)=>[
            r.kbArticleId,
            r._count._all
        ]));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__04424ia._.js.map