...
"[project]/apps/dashboard/src/app/api/integrations/_lib/validation.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function parseCreateIntegrationBody(body) {
    ...
    if (!platform || !externalAccountId) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Missing platform or externalAccountId');
    }
    if (typeof platform !== 'string' || !Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$thread$2d$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CHANNEL_TYPE"]).includes(platform)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Invalid platform');
    }
    return {
        platform: platform,
        externalAccountId,
...
"[project]/apps/dashboard/src/app/api/integrations/_lib/integration-upsert.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "isIntegrationUniqueConstraintError",
    ()=>isIntegrationUniqueConstraintError,
    "upsertRaceSafeIntegration",
    ()=>upsertRaceSafeIntegration
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/db/dist/index.js [app-route] (ecmascript) <locals>");
;
const INTEGRATION_UNIQUE_TARGET = [
    'organizationId',
    'platform',
    'externalAccountId'
];
const INTEGRATION_UNIQUE_DB_TARGET = [
    'organization_id',
    'platform',
    'external_account_id'
];
...
function targetArrayMatches(target, expected) {
    const fields = target.filter((field)=>typeof field === 'string');
    return fields.length === expected.length && expected.every((field)=>fields.includes(field));
}
function targetStringMatches(target) {
    if (INTEGRATION_UNIQUE_CONSTRAINTS.has(target)) return true;
    const normalized = target.toLowerCase();
    return normalized.includes('integration') && normalized.includes('organization') && normalized.includes('platform') && normalized.includes('external') && normalized.includes('account');
}
function targetMatchesIntegrationUnique(target) {
    if (Array.isArray(target)) {
        return targetArrayMatches(target, INTEGRATION_UNIQUE_TARGET) || targetArrayMatches(target, INTEGRATION_UNIQUE_DB_TARGET);
    }
    return typeof target === 'string' && targetStringMatches(target);
}
function isIntegrationUniqueConstraintError(error) {
    if (!(error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Prisma"].PrismaClientKnownRequestError)) return false;
...
async function updateIntegrationById(id, data) {
    if (!hasUpdateData(data)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].integration.findUniqueOrThrow({
            where: {
                id
            }
        });
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].integration.update({
        where: {
            id
        },
        data
...
async function upsertRaceSafeIntegration(args) {
    ...
    const where = {
        organizationId_platform_externalAccountId: key
    };
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].integration.findUnique({
        where
    });
    if (existing) {
    ...
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].integration.create({
            data: {
                ...key,
                ...data
            }
        ...
        const race = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].integration.findUnique({
            where
        });
        if (!race) throw err;
...
"[project]/apps/dashboard/src/app/api/integrations/_lib/email-integration.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "saveForwardingEmailIntegration",
    ()=>saveForwardingEmailIntegration,
    "upsertExclusiveEmailIntegration",
    ()=>upsertExclusiveEmailIntegration
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/db/dist/index.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$integrations$2f$_lib$2f$integration$2d$upsert$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/dashboard/src/app/api/integrations/_lib/integration-upsert.ts [app-route] (ecmascript)");
;
;
async function upsertExclusiveEmailIntegration(args) {
    const saved = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$integrations$2f$_lib$2f$integration$2d$upsert$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upsertRaceSafeIntegration"])({
        organizationId: args.organizationId,
        platform: 'email',
        externalAccountId: args.externalAccountId,
        data: {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].integration.deleteMany({
        where: {
            organizationId: args.organizationId,
            platform: 'email',
            id: {
...
async function saveForwardingEmailIntegration(args) {
    const integration = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$integrations$2f$_lib$2f$integration$2d$upsert$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upsertRaceSafeIntegration"])({
        organizationId: args.organizationId,
        platform: 'email',
        externalAccountId: args.externalAccountId,
        data: {
...
"[project]/apps/dashboard/src/app/api/integrations/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$integrations$2f$_lib$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/dashboard/src/app/api/integrations/_lib/validation.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$thread$2d$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/agent/dist/thread-constants.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$integrations$2f$_lib$2f$email$2d$integration$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/dashboard/src/app/api/integrations/_lib/email-integration.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$integrations$2f$_lib$2f$integration$2d$upsert$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/dashboard/src/app/api/integrations/_lib/integration-upsert.ts [app-route] (ecmascript)");
;
;
;
...
;
;
function serializeIntegration(integration, lastActivity, threadsThisWeek) {
    const safe = {
        ...integration
    };
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withOrgRoute"])({
    ...
    const [integrations, activityRows, weeklyRows] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].integration.findMany({
            where: {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].thread.groupBy({
            by: [
                'channelType'
            ],
            where: {
    ...
    const lastActivityByChannel = {};
    for (const row of activityRows){
        lastActivityByChannel[row.channelType] = row._max.updatedAt?.toISOString() ?? null;
    }
    const weeklyByChannel = {};
    for (const row of weeklyRows){
        weeklyByChannel[row.channelType] = row._count._all;
    }
    const result = integrations.map((i)=>serializeIntegration(i, lastActivityByChannel[i.platform] ?? null, weeklyByChannel[i.platform] ?? 0));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(result);
});
const POST = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withOrgRoute"])({
    ...
    const { platform, externalAccountId, fromEmail } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$integrations$2f$_lib$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseCreateIntegrationBody"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$body$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readRequiredJsonObject"])(request));
    const platformValue = platform;
    if (platformValue === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$thread$2d$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CHANNEL_TYPE"].EMAIL) {
        const normalizedEmail = String(externalAccountId).trim().toLowerCase();
        if (!normalizedEmail) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Missing platform or externalAccountId');
        }
        const normalizedFromEmail = fromEmail === undefined || fromEmail === null ? normalizedEmail : String(fromEmail).trim().toLowerCase() || normalizedEmail;
        const integration = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$integrations$2f$_lib$2f$email$2d$integration$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveForwardingEmailIntegration"])({
            organizationId: org.id,
            externalAccountId: normalizedEmail,
            fromEmail: normalizedFromEmail
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(serializeIntegration(integration), {
            status: 201
        });
    }
    const integration = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$integrations$2f$_lib$2f$integration$2d$upsert$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upsertRaceSafeIntegration"])({
        ...
        data: {
            ...fromEmail !== undefined && {
                fromEmail: fromEmail === null ? null : String(fromEmail)
            }
        }
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(serializeIntegration(integration), {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0y.z97n._.js.map