...
"[project]/apps/dashboard/src/lib/api/validation.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/agent/dist/errors.js [app-route] (ecmascript)");
;
function assertKnownFields(body, allowedFields, message = 'Invalid request body') {
    const allowed = new Set(allowedFields);
    const unknownField = Object.keys(body).find((field)=>!allowed.has(field));
    if (!unknownField) return;
    throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"](message, [
        {
            code: 'unknown_field',
            field: unknownField,
...
function requireNonEmptyString(value, field, message = `${field} is required`) {
    if (typeof value !== 'string' || !value.trim()) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"](message);
    }
    return value.trim();
}
function optionalNonEmptyString(value, field, message = `${field} must be a non-empty string`) {
...
function optionalString(value, field, message = `${field} must be a string`) {
    if (value === undefined) return undefined;
    if (typeof value !== 'string') {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"](message);
    }
...
function optionalBoolean(value, field, message = `${field} must be a boolean`) {
    if (value === undefined) return undefined;
...
function normalizeStringArray(value, field, defaultValue = []) {
    if (value === undefined) return defaultValue;
    if (!Array.isArray(value)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"](`${field} must be an array`);
    }
...
"[project]/apps/dashboard/src/app/api/threads/_lib/validation.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/dashboard/src/lib/api/validation.ts [app-route] (ecmascript)");
;
;
;
;
;
const THREAD_PATCH_FIELDS = [
    'status',
    'tag',
    'shopifyCustomerId',
    'filterStatus',
...
const BULK_THREAD_PATCH_FIELDS = [
    'ids',
    'action',
    'tag'
];
const SHOPIFY_THREAD_FIELDS = [
    'shopifyCustomerId',
    'customerEmail',
    'customerName',
    'orderName'
];
const BULK_THREAD_ACTIONS = [
    'close',
    'open',
    'tag',
    'archive'
...
function parseOptionalNullableString(value, field) {
    ...
    if (typeof value !== 'string') {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"](`${field} must be a string`);
    }
    return value;
}
function parseOptionalTrimmedString(value, field) {
...
function parseOptionalThreadStatus(value) {
    if (value === undefined) return undefined;
    if (!Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$thread$2d$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["THREAD_STATUS"]).includes(value)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Invalid status');
    }
    return value;
}
function parseOptionalFilterStatus(value) {
    if (value === undefined) return undefined;
    if (!Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ThreadFilterStatus"]).includes(value)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Invalid filterStatus');
    }
    return value;
}
function parseOptionalFilterFeedback(value) {
    if (value === undefined) return undefined;
    if (!Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ThreadFilterFeedback"]).includes(value)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Invalid filterFeedback');
    }
    return value;
}
function parseThreadPatchBody(body) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertKnownFields"])(candidate, THREAD_PATCH_FIELDS);
    const parsed = {
    ...
    if (parsed.status === undefined && parsed.tag === undefined && parsed.shopifyCustomerId === undefined && parsed.filterStatus === undefined && parsed.filterFeedback === undefined) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Missing status, tag, shopifyCustomerId, filterStatus, or filterFeedback');
    }
    return parsed;
}
function parseThreadIds(value) {
    if (!Array.isArray(value) || value.length === 0) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Missing ids');
    }
    if (value.length > 100) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Too many ids — max 100 per request');
    }
    if (value.some((id)=>typeof id !== 'string' || !id.trim())) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('ids must contain thread ids');
    }
    return value.map((id)=>id.trim());
}
function parseBulkAction(value) {
    if (!BULK_THREAD_ACTIONS.includes(value)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Invalid action');
    }
    return value;
}
function parseBulkThreadPatchBody(body) {
    const candidate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$body$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireJsonObject"])(body, {
        message: 'Invalid request body'
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertKnownFields"])(candidate, BULK_THREAD_PATCH_FIELDS);
    ...
    if (action === 'tag' && tag === undefined) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('tag is required');
    }
    return {
        ids,
        action,
...
function parseShopifyThreadBody(body) {
    const candidate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$body$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireJsonObject"])(body, {
        message: 'Invalid request body'
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertKnownFields"])(candidate, SHOPIFY_THREAD_FIELDS);
    return {
        shopifyCustomerId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireNonEmptyString"])(candidate.shopifyCustomerId, 'shopifyCustomerId', 'Missing shopifyCustomerId or customerEmail'),
        customerEmail: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireNonEmptyString"])(candidate.customerEmail, 'customerEmail', 'Missing shopifyCustomerId or customerEmail'),
...
"[project]/apps/dashboard/src/app/api/threads/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$thread$2d$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/agent/dist/thread-constants.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$threads$2f$_lib$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/dashboard/src/app/api/threads/_lib/validation.ts [app-route] (ecmascript)");
;
;
;
;
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withOrgRoute"])({
    context: 'Threads GET by id',
    errorMessage: 'Failed to fetch thread'
}, async ({ org, params })=>{
    const { id } = params;
    const thread = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].thread.findFirst({
        where: {
            id,
    ...
    if (!thread) throw new __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotFoundError"]('Thread not found');
    ...
    const actionRows = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].agentAction.findMany({
        where: {
            organizationId: org.id,
            threadId: id
        },
...
const PATCH = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withOrgRoute"])({
    context: 'Threads PATCH',
    errorMessage: 'Failed to update thread'
}, async ({ org, request, params })=>{
    const { id } = params;
    const { status, tag, shopifyCustomerId, filterStatus, filterFeedback } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$app$2f$api$2f$threads$2f$_lib$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseThreadPatchBody"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$body$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readRequiredJsonObject"])(request));
    const thread = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].thread.findUnique({
        where: {
            id
        },
        select: {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$lib$2f$api$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertEntityInOrg"])(thread, org.id, 'Thread not found');
    // Closing a questionable thread implies the merchant treated it as legit.
    const resolvedFeedback = filterFeedback ?? (status === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$agent$2f$dist$2f$thread$2d$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["THREAD_STATUS"].CLOSED && thread.filterStatus === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ThreadFilterStatus"].questionable ? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ThreadFilterFeedback"].confirmed_genuine : undefined);
    const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].thread.update({
        where: {
            id
        },
        data: {
            ...status && {
                status,
                cachedPlan: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$db$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Prisma"].DbNull,
            ...
            ...resolvedFeedback !== undefined && {
                filterFeedback: resolvedFeedback
            }
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__04qfgpi._.js.map