...
export default function OnboardingShell({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-white">
      ...
      />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[350px] opacity-[0.12] pointer-events-none blur-[120px] bg-gradient-to-b from-yellow-400 to-transparent z-0" />
