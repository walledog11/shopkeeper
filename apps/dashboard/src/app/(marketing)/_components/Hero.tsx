      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6 max-w-5xl">
        ...
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter text-slate-900 leading-[1.05] max-w-3xl">
            ...
            <span className="text-green-500">e-commerce brands.</span>
          </h1>

          <Image src="/images/dotted-line-plane.png" alt="line graphic" width={700} height={200} className=""/>
          ...
          <div className="flex flex-col items-center gap-3 mt-2">
            <Button
              size="lg"
              className="h-12 px-8 text-base font-semibold rounded-full bg-green-400 text-green-950 shadow-lg hover:bg-green-500 hover:shadow-xl transition-all"
              asChild
            >
