...
export function TicketQueueLoading() {
  return (
    <div aria-busy="true" aria-label="Loading tickets" className="flex-1 overflow-hidden">
      <div className="mx-auto flex w-full max-w-2xl flex-col gap-3 px-5 py-6 md:px-6">
