...
const GLASS_SHELL = cn("rounded-[22px] px-2.5 py-2", GLASS_CARD_SURFACE)
const GLASS_CONTROL = "border border-white/55 bg-white/40 shadow-[inset_0_1px_0_rgba(255,255,255,0.55)] backdrop-blur-md backdrop-saturate-150 supports-[backdrop-filter]:bg-white/25"
