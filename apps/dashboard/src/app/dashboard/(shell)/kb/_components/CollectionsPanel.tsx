    ...
    <>
      ...
      <div className="flex justify-end gap-1 mt-2">
        ...
        <button type="button" onClick={onSubmit}
          ...
          className="flex items-center gap-1 text-xs font-semibold text-white bg-foreground/[0.12] hover:bg-foreground/[0.18] disabled:opacity-40 px-2 py-1 rounded transition-colors"
        >
...
function CollectionRow({
  ...
  return (
    <div className={`group flex items-center rounded-md transition-colors ${active ? 'bg-foreground/[0.10]' : 'hover:bg-foreground/[0.05]'}`}>
      <button
        type="button"
        onClick={onClick}
        aria-pressed={active}
