      ...
      <div className="mx-auto w-full max-w-3xl space-y-6 px-4 py-6 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="overflow-hidden rounded-xl border border-border bg-card">
          <div className="grid grid-cols-1 gap-4 p-5 sm:grid-cols-[180px_1fr] sm:gap-8 sm:p-6">
            ...
            <div className="flex items-center gap-4 rounded-md border border-white/[0.07] bg-white/[0.04] p-4">
              <div className="flex size-10 shrink-0 items-center justify-center overflow-hidden rounded-full bg-white/[0.10] text-sm font-bold text-white">
                {userImageUrl ? (
                  <Image
                    src={userImageUrl}
                    alt={userName}
              ...
              <Button
                ...
                className="h-8 shrink-0 border-white/[0.10] text-xs font-semibold text-white/60 hover:bg-white/[0.08]"
              >
                Edit profile
              </Button>
            </div>
        ...
        <div className="overflow-hidden rounded-xl border border-border bg-card">
          <div className="grid grid-cols-1 gap-4 p-5 sm:grid-cols-[180px_1fr] sm:gap-8 sm:p-6">
            <div>
              <h2 className="text-sm font-semibold text-white/75">Security</h2>
              <p className="mt-1 text-xs leading-relaxed text-white/35">
        ...
        <div className="overflow-hidden rounded-xl border border-red-500/20">
          ...
          <div className="space-y-3 p-5 sm:p-6">
            <p className="text-xs leading-relaxed text-white/40">
              ...
              <Link href="/dashboard/settings?tab=workspace" className="font-semibold text-white/60 hover:text-white/80">
                workspace settings
              </Link>
