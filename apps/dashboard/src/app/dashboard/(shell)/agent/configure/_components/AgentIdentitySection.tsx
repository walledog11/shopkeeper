...
function VoiceProposalCard({
  ...
  return (
    <div className="rounded-md border border-violet-300/30 bg-violet-300/[0.06] p-3.5 space-y-3">
      ...
      <p className="text-sm text-strong leading-relaxed rounded border border-foreground/[0.08] bg-foreground/[0.03] px-3 py-2 whitespace-pre-wrap break-words">
        {brief}
      </p>
      {rationale && (
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          disabled={busy !== null}
          className="inline-flex items-center gap-1.5 h-8 px-3 rounded-md border border-foreground/[0.12] text-muted-foreground hover:text-strong hover:border-foreground/[0.22] disabled:opacity-50 text-xs font-semibold transition-colors"
        >
