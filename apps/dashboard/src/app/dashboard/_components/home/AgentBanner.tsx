    ...
    <AnimatePresence initial={false}>
      {!dismissed && (
        ...
        >
          ...
          <Card className="relative border border-white/[0.06] rounded-md overflow-visible" style={{ background: "linear-gradient(135deg, #141414 0%, #0a0a0a 60%, #0d0b0a 100%)" }}>
            ...
            <div className="flex items-stretch justify-left pl-4 sm:h-[150px]">
              ...
              {/* Content */}
              <div className="flex-1 min-w-0 flex flex-col sm:flex-row sm:items-center sm:gap-6 px-4 py-3">
                <div className="flex-1 min-w-0">
                  ...
                  <h2 className="text-base font-bold text-white leading-tight">Set up your AI agent</h2>
                  <p className="text-xs text-white/40 mt-0.5">
                    Automatically resolve the most common questions from your customers.
                  </p>
                </div>

                <div className="flex flex-col items-stretch gap-2 mt-4 sm:mt-0 shrink-0">
                  <Link
                    href="/dashboard/settings?tab=agent"
                    className="w-full sm:w-auto text-center bg-green-400 hover:bg-green-300 active:bg-green-500 text-black text-sm font-semibold px-15 py-2 rounded-lg shadow-[0_0_16px_rgba(250,204,21,0.2)] hover:shadow-[0_0_20px_rgba(250,204,21,0.35)] transition-all duration-150 select-none"
                  >
                    Start
                  </Link>
                  <button
                    onClick={dismiss}
                    className="w-full sm:w-auto text-sm font-medium text-white/40 hover:text-white/70 border border-white/10 hover:border-white/20 px-15 py-2 rounded-lg transition-all duration-150"
                  >
                    Maybe later
                  </button>
                </div>
