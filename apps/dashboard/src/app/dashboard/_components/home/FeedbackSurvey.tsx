      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-2.5 px-4 py-3">
        ...
        <div className="flex items-center gap-2.5 flex-1 min-w-0">
          ...
          <button
            ...
            className="shrink-0 px-3 py-1.5 rounded-md bg-green-400 text-black text-xs font-semibold disabled:opacity-30 disabled:cursor-not-allowed hover:bg-green-300 transition-colors"
          >
            Send
          </button>
