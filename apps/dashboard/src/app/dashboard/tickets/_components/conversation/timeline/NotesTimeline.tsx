          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-baseline gap-1.5 mb-1.5">
                ...
                <span className="text-xs text-white/30">added a note</span>
                <span className="text-xs text-white/25 ml-auto">{msg.time}</span>
              </div>
      ...
      {agentTurns.map((turn, index) => (
        <div key={turn.id ?? `${turn.instruction}-${index}`} className="space-y-2">
          <div className="flex flex-col gap-1 items-end">
            {turn.senderPhone && (
              <div className="flex items-center gap-1 text-xs text-white/30 mr-1">
