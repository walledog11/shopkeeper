...
export default function OrderCardGrid({ orders, hasMore, isLoadingMore, loadMoreError, onLoadMore }: Props) {
  if (orders.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        <p className="text-sm font-semibold text-muted-foreground mb-1">No orders found</p>
