...
export const CARD_SHELL = cn(
  "group flex flex-col rounded-2xl bg-card border border-border px-5 pt-5 pb-5 scroll-mt-6",
...
export const CARD_DESCRIPTION = "mt-2 line-clamp-3 text-[13.5px] leading-[18px] text-muted-foreground"
