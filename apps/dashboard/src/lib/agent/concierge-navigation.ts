...
const EXPLICIT_PAGE_PATTERN = /\b(integrations page|settings page|agent settings|agent configure|trust level|organization settings|workspace settings|account settings)\b/;
