...
- V1 launch env covers email and Shopify. Meta and Twilio vars are optional until those channels are reintroduced. There are no carrier-tracking env vars: shipment and delivery monitoring were removed on 2026-08-26.
